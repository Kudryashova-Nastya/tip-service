                ...
                <div className="w-full grid grid-cols-1 col-start-4 col-span-6">
                    <div className="card_staff p-6 grid grid-cols-1 md:grid-cols-12">
                        <div className="col-start-1 col-span-9 items-center md:grid-cols-1 pl-7">
                            <h2 className="staff_name mb-1">{StaffStore.staffInfo.last_name} {StaffStore.staffInfo.first_name}</h2>
                            ...
                            <p className="mb-1">Номер карты: {StaffStore.staffInfo.card_number}</p>
                            <p className="mb-1">Логин: {StaffStore.staffInfo.user}</p>
                        </div>
